...
### To Do
- [x] React Projects & `jsconfig.json`
- [x] Review of JSX
- [x] State (`useState`)
- [x] Controlled Lists & Inputs
- [x] `Form/onSubmit `vs `Button/onClick`
- [x] Fetching Data from an API (`useEffect`)
- [x] Parent/Child Components & Props
- [x] custom Hooks
- [x] React "build" `npm run build`
- [x] Q and A
...
### Props
* Props is an Object that is passed into the component from the parent
